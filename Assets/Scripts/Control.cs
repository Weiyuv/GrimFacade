...
public class control : MonoBehaviour
{
    ...
    private int jumpCount = 0; // Contador para os pulos.
    public int maxJumps = 2; // Número máximo de pulos (1 no chão e 1 no ar).
    ...
    private void JumpRoutine(RaycastHit2D hit)
    {
        ...
        {
            jumpCount = 0; // Reseta o contador de pulos quando o personagem toca o chão
        }

        // Verifica se o personagem pode pular (primeiro pulo ou segundo pulo no ar)
    ...
    {
        // Aqui você pode adicionar algum comportamento quando o personagem tomar dano.
